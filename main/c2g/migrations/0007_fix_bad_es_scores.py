...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        if not db.dry_run:
            db.execute('update c2g_examscore es, es_scores_for_correcting esfc set es.score = esfc.max_er_score where es.id = esfc.es_id')
            print "Updated examscore.score records successfully"
